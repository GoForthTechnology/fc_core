...
class RenderedObservation {
  ...
  RenderedObservation(
      ...
      this.hasMucus,
      this.inFlow,
      this.fertilityReasons,
      this.infertilityReasons,
      this.essentiallyTheSame,
      this.debugInfo,
      this.date);

  static RenderedObservation blank(LocalDate date) {
    return RenderedObservation("", 0, false, false, false, false, [], [], null,
        const DebugInfo(), date);
  }
  ...
  factory RenderedObservation.fromJson(Map<String, dynamic> json) =>
      _$RenderedObservationFromJson(json);
