...
class Observation {
  ...
  bool get hasPeakTypeMucus {
    return dischargeSummary == null
        ? false
        : dischargeSummary!.hasPeakTypeMucus;
  }

  bool get hasNonPeakTypeMucus {
    return dischargeSummary == null
        ? false
        : dischargeSummary!.hasNonPeakTypeMucus;
  }
...
class DischargeSummary {
  ...
  DischargeSummary(
      ...
      this.dischargeDescriptors = const []});
  ...
  bool operator ==(Object other) {
    ...
    return other is DischargeSummary &&
        ...
        const ListEquality()
            .equals(other.dischargeDescriptors, dischargeDescriptors);
  }

  @override
  int get hashCode =>
      Object.hash(dischargeType, dischargeFrequency, dischargeDescriptors);
...
abstract mixin class DischargeComponent {
  String get code;
}
